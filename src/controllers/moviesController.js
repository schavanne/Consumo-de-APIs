...
const moviesController = {
    ...
    'buscar': async (req, res) => {
        ...
        let runtime = 0;
        let release_date = "1970-01-01 01:01:01";
        try {
            ...
            if(!movie){
                ...
                const {Title, Released, imdbRating, Awards, Runtime} = pelicula;
            ...
            /*    let awardsArray = Awards.split(' ');
                ...
                if(pelicula.Response != "False"){
                    ...
                    movie = await db.Movie.create({
                        ...
                        length : parseInt(runtime[0]),
                        genre_id : null
                    });

                    const res = await fetch(pelicula.Poster);
                    const fileStream = fs.createWriteStream("./public/img/movies/"+movie.id+"-movie.jpg");
